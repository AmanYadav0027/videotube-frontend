...
const navStyles = `
  ...
  @keyframes pulseDot {
    0%,100% { transform: scale(1);   box-shadow: 0 0 10px rgba(99,102,241,0.7); }
    50%     { transform: scale(1.3); box-shadow: 0 0 18px rgba(236,72,153,0.9); }
  }
  ...
  .navbar-hamburger-label:hover {
    background: rgba(99,102,241,0.15);
    border-color: rgba(99,102,241,0.35); color: #fff;
  }
  ...
  .navbar-drawer-search input:focus {
    background: rgba(99,102,241,0.08);
    border-color: rgba(99,102,241,0.45);
    box-shadow: 0 0 0 3px rgba(99,102,241,0.12);
  }
  ...
  .navbar-drawer-link {
    ...
    padding: 11px 14px; font-size: 0.9375rem; font-weight: 500;
  ...
  .navbar-drawer-link:hover {
    ...
    border-color: rgba(99,102,241,0.2); color: #fff;
  }
  .navbar-drawer-dot {
    width: 6px; height: 6px; border-radius: 50%;
    background: linear-gradient(135deg, #6366f1, #ec4899);
    opacity: 0.5; flex-shrink: 0; transition: opacity 0.18s;
  }
  .navbar-drawer-link:hover .navbar-drawer-dot { opacity: 1; }

  /* Drawer — logged-in profile row */
  .navbar-drawer-profile {
    display: flex; align-items: center; gap: 12px;
    margin-top: 6px; padding: 11px 14px; border-radius: 10px;
  ...
  /* Drawer — logged-out sign in */
  .navbar-drawer-signin {
    display: flex; align-items: center; justify-content: center;
  ...
  @media (max-width: 600px) {
    ...
    .navbar-hamburger-label { display: flex; }
  }
`;
